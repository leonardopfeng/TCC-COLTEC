...
INSERT INTO `clientes` VALUES (3,2);
...
INSERT INTO `exercicios` VALUES (3,'Gustavo','321321',1);
...
CREATE TABLE `exercicios_treino` (
  `id_treino_exercicio` varchar(45) NOT NULL,
  ...
  CONSTRAINT `fk_treinos_has_exercicios_exercicios1` FOREIGN KEY (`id_exercicio`) REFERENCES `exercicios` (`id_exercicio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_treinos_has_exercicios_treinos1` FOREIGN KEY (`id_treino`) REFERENCES `treinos` (`idtreinos`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `grupo_muscular` VALUES (1,'Triceps'),(2,'Biceps');
...
-- Dump completed on 2021-07-26 18:59:30
